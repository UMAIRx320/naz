...
def ua_krek():
        ...
        ua = (f"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1811 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.198 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/194.0.0.42.99;]")
        return ua
...
def ua_crack():
		...
		ngentod = f"Mozilla/5.0 (Linux; Android 11.0.1; HUAWEI Nova 5T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36"
